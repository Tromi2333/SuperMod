...
public enum ArmorMaterials implements ArmorMaterial {
    ...
    SUPER("super", 2147483647, new int[]{2147483647, 2147483647, 2147483647, 2147483647}, 19,
                SoundEvents.ARMOR_EQUIP_NETHERITE, Float.MAX_VALUE, Float.MAX_VALUE, () ->
            {
                return Ingredient.of(Items.SUPER_INGOT.get());
            });
    ...
    {
        return SuperMod.MOD_ID + ":" + this.name;
    }
